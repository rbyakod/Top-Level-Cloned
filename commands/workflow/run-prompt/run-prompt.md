...
**Tresor Integration**: Can invoke prompts that use Tresor's 141 agents (@systems-architect, @security-auditor, etc.) and support Tresor's subagent types (Explore, Plan, general-purpose).
</objective>
